...
dotenv.config();
export default async function generateTrainingPlan(profile) {
    ...
    try {
        ...
        if (!content) {
            console.error("[AI] No content in response:", JSON.stringify(completion, null, 21));
